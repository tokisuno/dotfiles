...
set -U XDG_DATA_DIRS $XDG_DATA_DIRS "$HOME/.local/share/flatpak/exports/share"
...
# fish_add_path "$HOME/.local/share/gem/ruby/3.6.5/bin"
...
fish_add_path "$HOME/.rbenv/versions/3.3.5/bin/gem"
fish_add_path "$HOME/.rbenv/versions/3.3.5/bin/bundle"
fish_add_path "$HOME/.rbenv/versions/3.3.5/bin/bundler"
