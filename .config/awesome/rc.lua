...
awful.screen.connect_for_each_screen(function(s)
	...
	s.mymodule = mymodule()
	s.spacer = wibox.widget({ text = " | ", widget = wibox.widget.textbox })
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "=", function()
		awful.tag.setgap(dpi(16))
	end, { description = "set useless gap to dpi(16)", group = "awesome" }),
	awful.key({ modkey }, "-", function()
		awful.tag.setgap(dpi(0))
	end, { description = "remove useless gap (set to dpi(0))", group = "awesome" }),
	-- Layout manipulation
